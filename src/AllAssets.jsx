...
<button type="button" id='2' onClick={() => setFilterId(2)} className="block px-4 py-2 w-full hover:bg-gray-200 dark:hover:bg-gray-800" role="menuitem">
  NFTs
</button>
<button type="button" id='1' onClick={() => setFilterId(1)} className="block px-4 py-2 w-full  hover:bg-gray-200 dark:hover:bg-gray-800" role="menuitem">
  Photography
</button>
<button type="button" id='0' onClick={() => setFilterId(0)} className="block px-4 py-2 w-full  hover:bg-gray-200 dark:hover:bg-gray-800" role="menuitem">
  Digital Arts
</button>
<button type="button" id='3' onClick={() => setFilterId(3)} className="block px-4 py-2 w-full  hover:bg-gray-200 dark:hover:bg-gray-800" role="menuitem">
  Logo
</button>
<button type="button" id='4' onClick={() => setFilterId(4)} className="block px-4 py-2 w-full  hover:bg-gray-200 dark:hover:bg-gray-800" role="menuitem">
  3d Arts
</button>

...
const CreatorProfile = () => {
    ...
    return (
        <section className="bg-black">
            <section className="header flex justify-between p-10 pt-20">
            ...
            <section className="creator-info mb-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 p-2">
                    ...
                    <div className="div1 p-10 mt-10 text-white">
                        ...
                        <div className=" mt-10 bg-zinc-900 rounded-lg p-4">
                            <div id="about" className={`bg-gray-800 text-white p-2 rounded-lg ${activeTab === 'about' ? '' : 'hidden'}`}>
                                <h2 className=" p-2 font-bold text-cyan-400 text-3xl">About {creator.name}</h2>
                                <p className="mt-3 p-2"> {creator.Bio}</p>
                                <div className="flex justify-between">
                                    <p className="text-1xl mt-1 text-cyan-400"> <i className="bi bi-heart"></i> {creator.Likes} </p>
                                    <p className="text-1xl mt-1 text-cyan-400">Sales : {creator.Sales}</p>
                                    <p className="text-1xl mt-1 text-cyan-400">Tokens: {creator.tokens}  <i className="bi bi-coin"></i></p>
                                </div>
                            </div>
                            ...
                            <h1 class="mx-3 mb-5 text-3xl font-bold">Get In Touch With {creator.name}</h1>
                                <i className="mx-3 text-cyan-400 text-2xl hover:text-cyan-200 bi bi-twitter-x"></i>
                                <i className="mx-3 text-cyan-400 text-2xl hover:text-cyan-200 bi bi-facebook"></i>
                                <i className="mx-3 text-cyan-400 text-2xl hover:text-cyan-200 bi bi-whatsapp"></i>
                                <i className="mx-3 text-cyan-400 text-2xl hover:text-cyan-200 bi bi-envelope"></i>
                            </div>
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-2 ">
                                {assets.map(asset => (
                                    ...
                                    <div key={asset.id} className="p-4 bg-gray-800 rounded-lg">
                                        ...
                                        <h3 className="mt-2 text-sm text-white">{asset.title}</h3>
                                    </div>
                                    </Link>
                                ))}
                            </div>
                    ...
                    <div className="image">
                        <img src={creator.image} className="rounded-lg w-full lg:px-20" alt="" />
                    </div>
                </div>
